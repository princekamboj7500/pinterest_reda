(() => {
  ...
  // extensions/pos-ui/src/Tile.jsx
  ...
  // node_modules/@shopify/ui-extensions/build/esm/surfaces/point-of-sale/render/components/Navigator/Navigator.mjs
  var Navigator = createRemoteComponent("Navigator");

  // node_modules/@shopify/ui-extensions/build/esm/surfaces/point-of-sale/render/components/PrintPreview/PrintPreview.mjs
  var PrintPreview = createRemoteComponent("PrintPreview");
  ...
  // node_modules/@shopify/ui-extensions/build/esm/surfaces/point-of-sale/render/components/Text/Text.mjs
  ...
  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/point-of-sale/render.mjs
  var import_react7 = __toESM(require_react(), 1);

  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/point-of-sale/context.mjs
  var import_react = __toESM(require_react(), 1);
  var ExtensionApiContext = /* @__PURE__ */ (0, import_react.createContext)(null);
  ...
  var RenderContext = /* @__PURE__ */ (0, import_react2.createContext)(null);
  ...
  function render(element, root, callback, reconciler = defaultReconciler) {
    ...
    if (!cached) {
      var _version$split;
      const major = Number(((_version$split = import_react3.version.split(".")) === null || _version$split === void 0 ? void 0 : _version$split[0]) || 18);
      const value = {
  ...
  function useRender() {
    const render3 = (0, import_react4.useContext)(RenderContext);
    if (render3 == null) {
  ...
  function createComponentWrapper(componentType, fragmentProps) {
    ...
    return /* @__PURE__ */ (0, import_react5.memo)(function ComponentWrapper(_a) {
      var _b = _a, {
        children: externalChildren = []
      } = _b, externalProps = __objRest(_b, [
        "children"
      ]);
      const fragments = (0, import_react5.useRef)({});
      const {
        root,
        reconciler
      } = useRender();
      const {
        ...
        for (const key of Object.keys(externalProps)) {
          ...
          if (fragmentProps.includes(key) && /* @__PURE__ */ (0, import_react5.isValidElement)(element)) {
        ...
        return {
          props: props2,
          children: [...import_react5.Children.toArray(externalChildren), ...portals]
        };
  ...
  // node_modules/@shopify/ui-extensions-react/build/esm/utilities/remoteRootRender.mjs
  var remoteRootRender = (node, root) => {
    return new Promise((resolve, reject) => {
      try {
  ...
  function reactExtension(target, render3) {
    return extension(target, (root, api) => __async(this, null, function* () {
      ...
      return remoteRootRender(/* @__PURE__ */ (0, import_jsx_runtime3.jsx)(ExtensionApiContext.Provider, {
        value: api,
...
${errorInfo.componentStack}`);
  ...
  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/point-of-sale/components/Button/Button.mjs
  var Button2 = createRemoteReactComponent(Button);

  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/point-of-sale/components/Navigator/Navigator.mjs
  var Navigator2 = createRemoteReactComponent(Navigator);

  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/point-of-sale/components/PrintPreview/PrintPreview.mjs
  var PrintPreview2 = createRemoteReactComponent(PrintPreview);

  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/point-of-sale/components/Screen/Screen.mjs
  var Screen2 = createRemoteReactComponent(Screen);

  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/point-of-sale/components/ScrollView/ScrollView.mjs
  var ScrollView2 = createRemoteReactComponent(ScrollView);

  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/point-of-sale/components/Text/Text.mjs
  var Text2 = createRemoteReactComponent(Text);

  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/point-of-sale/components/Tile/Tile.mjs
  var Tile2 = createRemoteReactComponent(Tile);

  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/point-of-sale/hooks/api.mjs
  var import_react15 = __toESM(require_react(), 1);

  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/point-of-sale/errors.mjs
  var PosUIExtensionError = class extends Error {
    constructor(...args) {
      super(...args);
      this.name = "PosUIExtensionError";
    }
  };
  ...
  function useApi(_target) {
    ...
    if (api == null) {
      throw new PosUIExtensionError("You can only call this hook when running as a point of sale UI extension.");
    }
    return api;
  }
  ...
  var Tile_default = reactExtension("pos.home.tile.render", () => {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TileComponent, {});
  });
  ...
  var Modal = () => {
    const api = useApi();
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Navigator2, { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Screen2, { name: "HelloWorld", title: "Hello World!", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(ScrollView2, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Text2, { children: "Welcome to the extension!!!!" }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(PrintPreview2, { src: "https://bilinguo--development.gadget.app/download-invoice?orderID=5746500534337&template=receiptInvoice&lang1=en&lang2=ar&isSingleLang=IS_SINGLE_LANG" })
    ] }) }) });
  };
  var Modal_default = reactExtension("pos.home.modal.render", () => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Modal, {}));

  // extensions/pos-ui/src/Order.jsx
  var import_react18 = __toESM(require_react());
  var import_jsx_runtime6 = __toESM(require_jsx_runtime());
  var ButtonComponent = () => {
    const api = useApi();
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Button2, { onPress: () => api.action.presentModal(), title: "Print with Billinguo" });
  };
  var Order_default = reactExtension(
    "pos.order-details.action.menu-item.render",
    () => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ButtonComponent, {})
  );

  // extensions/pos-ui/src/OrderDetails.jsx
  var import_react19 = __toESM(require_react());
  var import_jsx_runtime7 = __toESM(require_jsx_runtime());
  var Modal2 = () => __async(void 0, null, function* () {
    const api = useApi();
    const orderID = yield api.order.id;
    yield api.print.print(
      `https://bilinguo--development.gadget.app/pdf?orderId=${orderID}`
    );
    return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Navigator2, { children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(Screen2, { name: "OrderDetailsAction", title: "Order Details Action1", children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
        Button2,
        {
          title: "Print",
          onPress: () => api.print.print(
            "https://help.aronium.com/hc/user_images/4bXgr7C70h0dBx5UJSsWXQ.png"
          )
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(PrintPreview2, { src: "https://help.aronium.com/hc/user_images/4bXgr7C70h0dBx5UJSsWXQ.png" })
    ] }) });
  });
  var OrderDetails_default = reactExtension("pos.order-details.action.render", () => /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Modal2, {}));

  // extensions/pos-ui/src/OrderPurchase.jsx
  var import_react20 = __toESM(require_react());
  var import_jsx_runtime8 = __toESM(require_jsx_runtime());
  var ButtonComponent2 = () => {
    const api = useApi();
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Button2, { onPress: () => api.action.presentModal(), title: "Print with Billinguo" });
  };
  var OrderPurchase_default = reactExtension(
    "pos.purchase.post.action.menu-item.render",
    () => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(ButtonComponent2, {})
  );

  // extensions/pos-ui/src/OrderDetailsPurchase.jsx
  var import_react21 = __toESM(require_react());
  var import_jsx_runtime9 = __toESM(require_jsx_runtime());
  var Modal3 = () => {
    const api = useApi();
    api.print.print("https://help.aronium.com/hc/user_images/4bXgr7C70h0dBx5UJSsWXQ.png");
    return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Navigator2, { children: /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(Screen2, { name: "OrderDetailsAction", title: "Order Details Action1", children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
        Button2,
        {
          title: "Print",
          onPress: () => api.print.print("https://help.aronium.com/hc/user_images/4bXgr7C70h0dBx5UJSsWXQ.png")
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(PrintPreview2, { src: "https://help.aronium.com/hc/user_images/4bXgr7C70h0dBx5UJSsWXQ.png" })
    ] }) });
  };
  var OrderDetailsPurchase_default = reactExtension("pos.purchase.post.action.render", () => /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Modal3, {}));
})();
